/**
 * @file main.cpp
 * @author Vinay Krishna Bukka (Github Username: vinay06vinay), Suryavardhan Chappidi (Github Username: SuryaVC)
 * @brief The goal of the function is to compute the new velocity value using a PID controller
 * @version 0.1
 * @date 2023-10-09
 * 
...
int main() {
  ...
  // Calling the method compute of class pic to get the new velocity based on target setpoint and actual velocity
